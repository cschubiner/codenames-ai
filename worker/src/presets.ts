...
import agent_a_smoke from "../../shared/configs/agent_a_smoke.json" assert { type: "json" };
import agent_b_smoke from "../../shared/configs/agent_b_smoke.json" assert { type: "json" };

const PRESETS: Record<string, AgentConfig> = {
  agent_a: agent_a as AgentConfig,
  agent_b: agent_b as AgentConfig,
  agent_a_smoke: agent_a_smoke as AgentConfig,
  agent_b_smoke: agent_b_smoke as AgentConfig,
};
