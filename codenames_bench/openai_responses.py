...
class OpenAIResponsesClient:
    ...
    def create_json(
        ...
        *,
        ...
        Structured outputs are sent via response_format with json_schema.
...
def extract_output_text(resp_json: Dict[str, Any]) -> str:
    """
    Extracts the assistant message content from a Chat Completions API JSON payload.
    """
    ...
    if choices:
        ...
        if message.get("refusal"):
            raise RuntimeError(f"Model refusal: {message.get('refusal', '')}")
